...
REQUIRED_CASES = 17
REQUIRED = {
    "change_form_total": 17,
    "material_summary": 4,
    "metric_delta": 5,
    "attribution": 4,
    "level_comparison": 4,
    "explicit_measure_preserved": 13,
    "scope_preserved": 4,
    # v4's subject. Every reading must take a route its FORM accepts; which of the
    # valid routes it takes is reported, not preferred.
    "temporal_route_valid": 17,
}
...
def main(argv: List[str] | None = None) -> int:
    ...
    checks = [
        ...
        ("TEMPORAL_ROUTE_VALID",
         _num(totals.get("temporal_route_valid", 0)),
         REQUIRED["temporal_route_valid"]),
    ]
