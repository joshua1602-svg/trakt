...
from simulation.tools.build_regression_fixtures import (  # noqa: E402
    FIXTURE_ROOT, PINNED, condense,
)
    ...
    def test_the_economics_reproduce_exactly_from_the_committed_manifest(self):
        for case_id in PINNED:
            with self.subTest(case=case_id):
                ...
                regenerated = condense(build_expected_truth(case, generate_history(case)))
