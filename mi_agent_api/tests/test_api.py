...
def test_catalogue_exposes_real_semantic_layer():
    ...
    # share x group value, summing back to the portfolio figure). "min"/"max"
    # are the P1N extreme-value statistics of a measure — distinct from a
    # RANKING, which orders groups and returns the winning group. Enumerated
