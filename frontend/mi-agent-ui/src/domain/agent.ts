...
export interface AgentResponse {
   ...
   * the operator can see when a question was answered from a different book than
   * the active tab. */
  datasetContext?: string;
  /** How the question was parsed ("deterministic" | "llm"). */
  parserMode?: string;
...
export interface ChatMessage {
  ...
  datasetContext?: string;
  /** How the question was parsed ("deterministic" | "llm"), shown in the chip. */
  parserMode?: string;
