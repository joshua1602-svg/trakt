...
const NOV_PIPELINE: PipelineSnapshot = {
  ...
  sourceFile: "M2L KFI and Pipeline 2025_12_01_115711.xlsx",
  // The CURRENT snapshot (latest weekly extract) is distinct from the source-folder
  // date and from the historical observation window start.
  ...
  sourceFoldersIncluded: ["2025-10-01", "2025-11-01"],
  pipelineRowCount: 10,
  ...
  historicalModelEvidence: {
    weeklyFilesUsed: 10,
    weeklyFileNames: [
      "M2L KFI and Pipeline 2025_10_06.xlsx", "M2L KFI and Pipeline 2025_11_03.xlsx",
      "M2L KFI and Pipeline 2025_12_01_115711.xlsx",
    ],
