...
import type { KPIArtifact } from "@/domain";
import { cn } from "@/lib/utils";

export function KPIArtifactView({ artifact }: { artifact: KPIArtifact }) {
  return (
        ...
        const deltaColor =
          kpi.deltaIntent === "positive"
            ...
            : kpi.deltaIntent === "negative"
              ...
              : "text-ink-400";
        return (
          <div key={kpi.id} className="rounded-lg border border-[var(--color-line-soft)] bg-navy-850/60 p-3.5">
